...
private let CODE_QUERY_INVALID: String = "@candlefinance.financekit.query_invalid"
private let CODE_TRANSACTION_HISTORY_INVALID: String = "@candlefinance.financekit.transaction_history_invalid"
private let CODE_TRANSACTIONS_INVALID: String = "@candlefinance.financekit.transactions_invalid"
private let CODE_UNKNOWN: String = "@candlefinance.financekit.unknown"
private let CODE_UNKNOWN_ACCOUNT_TYPE: String = "@candlefinance.financekit.unknown_account_type"
private let CODE_UNKNOWN_AUTHORIZATION_STATUS: String = "@candlefinance.financekit.unknown_authorization_status"
private let CODE_UNKNOWN_CURRENT_BALANCE_TYPE: String = "@candlefinance.financekit.unknown_current_balance_type"
...
private let MESSAGE_UNKNOWN: String = "Something went wrong. Please file an issue on GitHub or try again."
private let MESSAGE_UNKNOWN_ACCOUNT_TYPE: String = "An Account with an unknown type was received from Apple's APIs. Please file an issue on GitHub."
private let MESSAGE_UNKNOWN_AUTHORIZATION_STATUS: String = "An AuthorizationStatus with an unknown type was received from Apple's APIs. Please file an issue on Github."
private let MESSAGE_UNKNOWN_CURRENT_BALANCE_TYPE: String = "A CurrentBalance with an unknown type was received from Apple's APIs. Please file an issue on GitHub."
