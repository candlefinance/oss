...
/**
 * Represents an instance of `SendParameters`, backed by a C++ struct.
 */
public typealias SendParameters = margelo.nitro.send.SendParameters

public extension SendParameters {
  private typealias bridge = margelo.nitro.send.bridge.swift

  /**
   * Create a new instance of `SendParameters`.
   */
