...
/**
 * Represents an instance of `SendRequest`, backed by a C++ struct.
 */
public typealias SendRequest = margelo.nitro.send.SendRequest

public extension SendRequest {
  private typealias bridge = margelo.nitro.send.bridge.swift

  /**
   * Create a new instance of `SendRequest`.
   */
  init(baseURL: String, path: String, query: SendParameters, header: SendParameters, method: SendMethod, body: String?, utf8ContentTypes: [String]) {
