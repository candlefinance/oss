...
namespace margelo::nitro::send::bridge::swift {
  ...
  /**
   * Specialized version of `std::optional<SendResponse>`.
   */
  using std__optional_SendResponse_ = std::optional<SendResponse>;
  inline std::optional<SendResponse> create_std__optional_SendResponse_(const SendResponse& value) {
    return std::optional<SendResponse>(value);
  }
