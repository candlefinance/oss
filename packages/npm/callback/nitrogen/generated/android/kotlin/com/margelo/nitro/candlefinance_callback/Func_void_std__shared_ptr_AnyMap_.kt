...
/**
 * Represents the JavaScript callback `(data: map) => void`.
...
class Func_void_std__shared_ptr_AnyMap_ {
  @DoNotStrip
  @Keep
   ...
   */
  fun toLambda(): (data: AnyMap) -> Unit = this::call
   ...
   */
  @FastNative
  external fun call(data: AnyMap): Unit
}
