...
namespace margelo::nitro::send {
  ...
  public:
    ...
    SendError toCpp() const {
      ...
      static const auto fieldCode = clazz->getField<JSendErrorCode>("code");
      jni::local_ref<JSendErrorCode> code = this->getFieldValue(fieldCode);
  ...
  public:
    ...
    static jni::local_ref<JSendError::javaobject> fromCpp(const SendError& value) {
      return newInstance(
        JSendErrorCode::fromCpp(value.code),
