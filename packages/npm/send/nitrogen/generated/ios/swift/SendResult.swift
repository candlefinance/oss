...
public extension SendResult {
   ...
   */
  init(response: SendResponse?, error: SendError?) {
    self.init({ () -> bridge.std__optional_SendResponse_ in
      if let actualValue = response {
        return bridge.create_std__optional_SendResponse_(actualValue)
      } else {
        return .init()
      }
  ...
  var response: SendResponse? {
    ...
    @inline(__always)
    set {
      self.__response = { () -> bridge.std__optional_SendResponse_ in
