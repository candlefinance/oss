...
namespace margelo::nitro::send {
  ...
  public:
    ...
    SendResult toCpp() const {
      ...
      static const auto fieldResponse = clazz->getField<JResponse>("response");
      jni::local_ref<JResponse> response = this->getFieldValue(fieldResponse);
  ...
  public:
    ...
    static jni::local_ref<JSendResult::javaobject> fromCpp(const SendResult& value) {
      return newInstance(
        value.response.has_value() ? JResponse::fromCpp(value.response.value()) : nullptr,
